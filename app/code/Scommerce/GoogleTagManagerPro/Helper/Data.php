...
class Data extends TrackingBaseHelper
{
    ...
    const XML_PATH_USE_UA_EVENTS        = 'googletagmanagerpro/general/use_ua_events';
    ...
    public function __construct(
        ...
        parent::__construct($context, $storeManager, $priceCurrency, $block);
        $this->_data = $data;
     ...
     * @return bool
     */
    public function useUaEvents($storeId = null)
    {
        return $this->scopeConfig->isSetFlag(
            self::XML_PATH_USE_UA_EVENTS,
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
